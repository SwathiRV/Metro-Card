...
public class ApplicationConfig {
    ...
    private final IPassengerService passengerService = new PassengerService(passengerRepository, stationRepository, 
    metroCardRepository, stationService, metroCardService);
    
    private final BalanceCommand balanceCommand = new BalanceCommand(metroCardService);
    private final CheckInCommand checkInCommand = new CheckInCommand(passengerService);
